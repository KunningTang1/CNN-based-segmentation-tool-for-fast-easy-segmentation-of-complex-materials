...
from utlis import label_accuracy_score,weights_init_normal
import os
#%% 
...
parser.add_argument('--model', type=str, default='UresNet', 
                    help='define which gpu to use, can be "UresNet" or "efficientUnet"')
...
class TrainDatasetFromFolder(Dataset):
    ...
    def __getitem__(self, index):
        image = Image.open(self.img1[index]).convert('RGB')
...
if opt.model == 'UresNet':
    ...
    net = get_efficientunet_b5(num_classes) 
